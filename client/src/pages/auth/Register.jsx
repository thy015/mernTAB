          ...
          <div className="row bg-slate-50 h-full shadow-lg g-0">
            ...
            <div className="col-8">
              <div className="row h-full">
                ...
                <div className="col-8">
                  <div className="py-20">
                    <h5 className="font-bold">Register with <span className="text-[#114098]">TakeABreath</span> </h5>
                    ...
                    <div className="mt-4">
                      <Form>
                        ...
                        <Form.Item>
                          <Button onClick={handleFormSubmit} className="my-2 bg-[#114098] ml-8">
                            Create Account
                          </Button>
                        </Form.Item>
                      </Form>
                    ...
                    <div className="flex justify-start">
                      ...
                      <Link to="/login" className="no-underline">
                        <span className="text-[#114098] cursor-pointer no-underline ml-2">Sign In</span>
                      </Link>
                    </div>
                    <div className="flex justify-start mt-3">
                      <span>I'm an owner</span>
                      <Link to="/loginOwner" className="no-underline">
                        <span className="text-[#114098] cursor-pointer no-underline ml-2">Sign In Owner</span>
                      </Link>
                    </div>
                  </div>
                </div>
