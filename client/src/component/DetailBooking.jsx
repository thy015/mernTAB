...
export default function DetailBooking() {
  ...
  return (
    <div className="p-6">
              ...
              {index < steps.length - 1 && (
                <div
                  className={`absolute h-1 ${
                    currentStep > step.id ? "bg-gray-700" : "bg-gray-300"
                  } transition-colors`}
                  style={{
      ...
      {/* Step Content */}
      <div className="p-4 mt-6 bg-gray-100 border border-gray-300 rounded">
        {currentStep === 1 && (
          <div>
            ...
            <div className="flex space-x-6">
              <div className="w-1/2">
                <h2 className="mb-4 text-xl font-bold">Special Order</h2>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  <label className="block mb-1 text-gray-700">Bed Type</label>
                  <select
                    className="block w-full p-2 border border-gray-300 rounded"
                    value={bedType}
            ...
            {/* Pay Method Section */}
            <div className="mt-6">
              <h2 className="mb-4 text-xl font-bold">Pay Method</h2>
        ...
        {currentStep === 2 && (
          <div>
            {/* Step 2 Content */}
            <h2 className="mb-4 text-xl font-bold">Review Your Details</h2>
            <div className="mb-4">
              ...
              <p>
                <strong>Phone Number:</strong> {formValues.phoneNumber}
              </p>
              <p>
        ...
        {currentStep === 3 && (
          <div>
            ...
            <h2 className="mb-4 text-xl">Thank you for booking with us!</h2>
            <h2>
              We look forward to welcoming you and hope you have a wonderful
              stay. <br></br>If you have any questions or need to make changes
              to your booking, please feel free to contact us at tabbooking@com
            </h2>
