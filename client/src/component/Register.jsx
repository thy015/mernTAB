...
const Register = () => {
  ...
  const handleSignUp = (e) => {
    ...
    if (dayjs(dob).isAfter(eighteenYearsAgo)) {
  ...
  return (
    <div
      className="flex items-center justify-center min-h-screen grid-cols-2 bg-center bg-cover"
      style={{
        backgroundImage:
    ...
    >
      <div className="w-full max-w-md p-6 mx-auto bg-white rounded-md shadow-md">
        <h2 className="mb-4 text-2xl font-bold text-center">Đăng Ký Chủ Nhà</h2>
